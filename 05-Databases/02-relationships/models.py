...
class Toy(db.Model):
    ...
    def __repr__(self):
        return f"Toy name is {self.item_name} and puppy_id is {self.puppy_id}"
...
class Owner(db.Model):
    ...
    def __repr__(self):
        return f"Owner name is {self.name} {self.id} and puppy_id is {self.puppy_id}"
